                        ...
                        <div class="col-xs-12">
                            <div class="panel-heading">
                                <ol class="breadcrumb">
                                    ...
                                    <li><a href="<?php echo site_url();?>admin/pesan_keluar">Pesan Keluar</a></li>
                                    <li class="active">Baca Pesan Keluar</li>
                                </ol>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-sm-4">
                                            ...
                                            <div class="box-header">
                                                ...
                                                <h3 class="box-title">Baca Pesan Keluar</h3>
                                            </div>
                                            <!-- compose message btn -->
                                            ...
                                            <div style="margin-top: 15px;">
                                                <ul class="nav nav-pills nav-stacked">
                                                    ...
                                                    <li class="active"><a href="<?php echo base_url(); ?>admin/pesan_keluar"><i class="fa fa-mail-forward"></i> Pesan Keluar</a></li>
                                                </ul>
                                            </div>
                                        </div><!-- /.col (LEFT) -->
                                        <div class="col-md-9">
                                            <div class="box box-primary">
                                                <div class="box-header with-border">
                                                    <div class="box-tools pull-right">
                                                        <a href="<?php echo base_url();?>admin/pesan_keluar" class="btn btn-box-tool" data-toggle="tooltip" title="Kembali">
                                                ...
                                                <div class="box-body no-padding">
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <h5>Dari&nbsp;&nbsp; : <?php echo $row->pengirim;?>
                                                        <h5>Untuk : <?php echo $row->nama;?>
                                                        <span class="mailbox-read-time pull-right"><?php echo $waktu;?></span></h5>
                                                    </div>

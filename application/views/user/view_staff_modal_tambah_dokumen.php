            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form action="<?php base_url();?>admin/cek_data_nip" method="POST" id="form_cek_data"> 
                            <div class="form-group">
                                <label>Masukan NIP</label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class=" glyphicon glyphicon-pencil"></i></span>
                                    <input name="nip" id="nip" type="text" class="form-control" placeholder="Nomor Induk Pegawai" 
                                    value="<?php echo $this->session->userdata('nip_staff'); ?>" readonly>
                                </div>
                            </div>
                        </form>    
                        <form action="<?php echo base_url();?>dokumen/staff_tambah_dokumen" method="POST" enctype="multipart/form-data" id="form_tambah_dokumen">
                            <div class="form-group">
                        ...
                        <div class="modal-footer clearfix">
                            ...
                            <button type="submit" class="btn btn-primary pull-left" id="kirim_dokumen"><i class="fa fa-location-arrow"></i> Kirim Dokumen</button>
                        </div>
                    </form>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->

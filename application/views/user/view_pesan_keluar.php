                                ...
                                <div class="col-md-3 col-sm-4">
                                    ...
                                    <div style="margin-top: 15px;">
                                        <ul class="nav nav-pills nav-stacked">
                                            ...
                                            <li><a href="<?php echo base_url(); ?>pesan"><i class="fa fa-inbox">
                                                <?php
                                            ...
                                            <li class="active">
                                                <a href="<?php echo base_url(); ?>pesan/pesan_keluar"><i class="fa fa-mail-forward"></i> Pesan Keluar</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div><!-- /.col (LEFT) -->
                                <div class="col-md-9 col-sm-8">
                                    <div class="box-body table-responsive">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                            <?PHP
                                                $query  = $this->model_pesan->view_pesan_keluar_admin($this->session->userdata('username_staff'));
                                                $no     = 1;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td<?php if($row->status == 'Belum Dibaca') echo ' style="color:#4B646F;"';?>>
                                                        <a href="<?php echo base_url();?>pesan/detail_pesan_keluar/<?php echo $row->id_pesan;?>">

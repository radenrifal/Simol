                                ...
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <ol class="breadcrumb" style="margin-bottom: 0;">
                                            ...
                                            <li>
                                                <a href="<?php site_url();?>pesan">
                                            	<span class="fa fa-envelope"></span>&nbsp; Pesan
                                                </a>
                                            </li>
                                            <li>&nbsp; Baca Pesan Baru</li>
                                        </ol>
                                    </div>
                                ...
                                <div class="col-md-3 col-sm-4">
                                    ...
                                    <div style="margin-top: 15px;">
                                        <ul class="nav nav-pills nav-stacked">
                                            ...
                                            <li class="active"><a href="<?php base_url(); ?>pesan"><i class="fa fa-inbox">
                                                <?php
                                            ...
                                            <li><a href="<?php base_url(); ?>pesan/pesan_keluar"><i class="fa fa-mail-forward"></i> Pesan Keluar</a></li>
                                        </ul>
                                    </div>
                                </div><!-- /.col (LEFT) -->
                                <div class="col-md-9">
                                    <div class="box box-primary">
                                        <div class="box-header with-border">
                                            <div class="box-tools pull-right">
                                                <a href="<?php echo base_url();?>pesan" class="btn btn-box-tool" data-toggle="tooltip" title="Kembali">

<!-- MODAL EDIT -->
<div class="modal fade" id="edit-dokumen-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo base_url(); ?>dokumen/update_dokumen" enctype="multipart/form-data" id="form_edit_dokumen">
                ...
                <div class="modal-footer clearfix">
                    ...
                    <button type="submit" form="form_edit_dokumen" class="btn btn-primary pull-left"><i class="glyphicon glyphicon-edit"></i> Perbarui Dokumen</button>
                </div>
            </form>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->

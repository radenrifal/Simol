<!-- MODAL TAMBAH -->
        <div class="modal fade" id="modal_staff_notulensi_rapat" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;&nbsp;Masukan Data Notulensi Rapat</h4>
                    </div>
                    <form action="<?php echo base_url();?>notulensi_rapat/insert_notulensi_rapat" method="POST" enctype="multipart/form-data" id="form_notulensi_rapat">
                        <div class="modal-body">
                            <div class="form-group">
                                <?php
                                    if($this->session->userdata('status') == 'admin || Admin'){
                                ?>
                                    <input type="hidden" name="nip" class="form-control pull-right" id="nip" value="<?php echo $this->session->userdata('nip_admin'); ?>"/>
                                <?php 
                                    }
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nip" class="form-control pull-right" id="nip" value="<?php echo $this->session->userdata('nip_staff'); ?>"
                                    readonly="hidden"/>
                                </div><!-- /.input group -->
                                <?php } ?>
                            </div><!-- /.form group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="tanggal_rapat" class="form-control datepicker pull-right" 
                                    data-date-format="yyyy-mm-dd" id="tanggal_rapat" placeholder="yyyy/mm/dd"/>
                                </div><!-- /.input group -->
                            </div><!-- /.form group -->
                            <div class="form-group">
                        ...
                        <div class="modal-footer clearfix">
                            ...
                            <button type="submit" class="btn btn-primary pull-left" ><i class="fa fa-location-arrow"></i> Kirim Notulensi Rapat</button>
                        </div>
                    </form>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->

<!-- MODAL TAMBAH -->
        <div class="modal fade" id="modal_edit_profil" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title"><i class="glyphicon glyphicon-edit"></i>&nbsp;&nbsp;Ubah Datadiri Pengguna</h4>
                    </div>
                    <form action="<?php echo base_url();?>profil/update_datadiri" method="POST" enctype="multipart/form-data" id="form_edit_datadiri">
                        <div class="modal-body">
                            <div class="row">
                            <div class="col-md-6">
                                <input type="hidden" name="id_datadiri_tmp" id="id_datadiri_tmp" class="form-control" readonly="hidden">
                                <label>NIP</label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-tags"></i></span>
                                    <input type="text" name="nip" id="nip_edit" class="form-control" placeholder="Nomor Induk Pegawai" readonly="hidden">
                                </div>
                                <br/>

<!-- MODAL TAMBAH -->
        <div class="modal fade" id="modal_notulensi_rapat" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url();?>admin/insert_notulensi_rapat" method="POST" enctype="multipart/form-data" id="form_notulensi_rapat">

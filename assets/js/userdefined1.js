...
$(document).ready(function(){
    ...
    $('#nama_tujuan').change(function(){
        ...
        $.ajax({
            ...
            data : {                            // Set data yang dikirim ke URL nya
                'nama_tujuan' : val,            // nama variabel : valuenya   
            },
            success: function(response) {       // Return/Respon dari AJAX saat sukses
                ...
                if(response.message == 'success'){      // Jika respon message success
                    ...
                    $('#email_tujuan').val(response.email);
    ...
    $('a#delete_pesan').click(function(e){
        e.preventDefault();
        $('form#form_delete_id_pesan').submit();
    });
    //==================================================================================================//
});